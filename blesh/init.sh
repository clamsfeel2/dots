...
#ble-face -s overwrite_mode            fg=blue
ble-face -s auto_complete             fg=grey,bold
#ble-face -s menu_filter_fixed         bold
ble-face -s menu_filter_input         fg=107
#ble-face -s vbell                     reverse
#ble-face -s vbell_erase               bg=252
#ble-face -s vbell_flash               fg=green,reverse
ble-face -s prompt_status_line        fg=231
...
ble-face -s syntax_function_name      fg=104,bold
#ble-face -s syntax_comment            fg=gray
#ble-face -s syntax_glob               fg=198,bold
#ble-face -s syntax_brace              fg=37,bold
#ble-face -s syntax_tilde              fg=33,bold
#ble-face -s syntax_document           fg=94
#ble-face -s syntax_document_begin     fg=94,bold
#ble-face -s command_builtin_dot       fg=red,bold
ble-face -s command_builtin           fg=108,bold
ble-face -s command_alias             fg=104,bold
ble-face -s command_function          fg=104,bold
ble-face -s command_file              fg=#b3bd68,bold
#ble-face -s command_keyword           fg=blue
#ble-face -s command_jobs              fg=red,bold
ble-face -s command_directory         fg=#81a2be,bold
#ble-face -s argument_option           fg=teal
#ble-face -s argument_option           fg=black,bg=225
ble-face -s filename_directory        fg=#81a2be,bold
ble-face -s filename_directory_sticky fg=#81a2be,bold
...
#ble-face -s filename_executable       underline
