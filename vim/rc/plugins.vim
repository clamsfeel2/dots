...
if empty(glob("$HOME/.config/vim/autoload/plug.vim"))
	silent execute "!curl -fLo $HOME/.config/vim/autoload/plug.vim --create-dirs  https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim"
endif
...
let g:gutentags_project_root = ["CMakeLists.txt", "package.json", ".git"]
